...
function countYearsInOffice(presidentsArr) {
  return presidentsArr.reduce((accumulator, yearsInOffice) => {
    if (yearsInOffice.leftOffice === null) return accumulator;
    accumulator += yearsInOffice.leftOffice - yearsInOffice.tookOffice;
    return accumulator;
  }, 0);
}
...
function getAgeAtInauguration(presidentsArr) {
  let ageAtInauguration = presidentsArr.map((president) => {
...
function countRepublicanPresidents(presidentsArr) {
  return presidentsArr.reduce((accumulator, president) => {
    return president.party === "Republican" ? accumulator + 1 : accumulator;
  }, 0);
}
...
function sortPresidentsByName(presidentsArr) {
  return presidentsArr.sort((president1, president2) =>
    president1.name.localeCompare(president2.name)
  );
}
